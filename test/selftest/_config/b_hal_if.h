...
#define HAL_MATRIXKEYS_IF                                                      \
    {                                                                          \
        .rows      = 4,                                                        \
        .columns   = 4,                                                        \
        .row_io    = {{B_HAL_GPIOE, B_HAL_PIN8}, {B_HAL_GPIOE, B_HAL_PIN9}},   \
        .column_io = {{B_HAL_GPIOE, B_HAL_PIN10}, {B_HAL_GPIOE, B_HAL_PIN11}}, \
    }

#define HAL_MCUFLASH_IF {0}
...
#define HAL_TESTMAC_IF {0}

#define HAL_XPT2046_IF                              \
    {                                               \
        ._if.spi       = B_HAL_SPI_3,               \
        .cs            = {B_HAL_GPIOC, B_HAL_PIN9}, \
        .is_simulation = 0,                         \
    }
...
#define HAL_ICM20948_IF                                      \
    {                                                        \
        .dev_addr               = 0Xd0,                      \
        .is_simulation          = 1,                         \
        ._if.simulating_i2c.clk = {B_HAL_GPIOB, B_HAL_PIN1}, \
        ._if.simulating_i2c.sda = {B_HAL_GPIOB, B_HAL_PIN0}, \
        ._if.simulating_i2c.frq = 1000000,                   \
    }
...
#define HAL_ICM42688P_IF                                     \
    {                                                        \
        .dev_addr               = 0Xd0,                      \
        .is_simulation          = 1,                         \
        ._if.simulating_i2c.clk = {B_HAL_GPIOA, B_HAL_PIN7}, \
        ._if.simulating_i2c.sda = {B_HAL_GPIOA, B_HAL_PIN6}, \
        ._if.simulating_i2c.frq = 1000000,                   \
    }
...
#define HAL_SMP3011_IF                                    \
    {.dev_addr               = (0x78 << 1),               \
     ...
     ._if.simulating_i2c.sda = {B_HAL_GPIOG, B_HAL_PIN6}, \
     ._if.simulating_i2c.frq = 100000}
#define HAL_ENC28J60_IF                                  \
    {                                                    \
        ._spi.is_simulation = 0,                         \
        ._spi.cs            = {B_HAL_GPIOA, B_HAL_PIN4}, \
        ._spi._if.spi       = B_HAL_SPI_1,               \
        .reset              = {B_HAL_GPIOA, B_HAL_PIN8}, \
    }
