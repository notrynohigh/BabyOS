...
#define TCPIP_NETCARD_DEVNO 1
#define TCPIP_USE_STATIC_IP 1
#define TCPIP_DEFAULT_IP "192.168.3.75"
#define TCPIP_DEFAULT_GW "192.168.3.1"
#define TCPIP_DEFAULT_MASK "255.255.255.0"
