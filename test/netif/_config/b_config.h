...
#define _SSL_SKIP_HOSTNAME_VERIFY 1
#define _MBEDTLS_PEM_PARSE_ENABLE 1
...
#define MEMP_MAX_SIZE 65536
#define _BOS_SERVICES_ENABLE 1
#define _TCPIP_SERVICE_ENABLE 1
#define _HTTP_SERVICE_ENABLE 1
#define _HTTP_RECV_BUF_SIZE 256
#define _HTTP_CLIENT_ENABLE 1
#define _HTTP_HOST_LEN_MAX 64
#define _HTTP_PATH_LEN_MAX 64
#define _HTTP_REQ_BODY_LEN 1024
#define _HTTP_SERVER_ENABLE 1
#define _NTP_SERVICE_ENABLE 1
#define _CONFIG_WEB_SERVICE_ENABLE 1
