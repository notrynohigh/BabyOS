...
ARM_NONNULL(2)
arm_fsm_rt_t arm_2dp_gray8_draw_point(arm_2d_op_drw_pt_t *ptOP, const arm_2d_tile_t *ptTarget,
...
ARM_NONNULL(2)
arm_fsm_rt_t arm_2dp_rgb565_draw_point(arm_2d_op_drw_pt_t *ptOP, const arm_2d_tile_t *ptTarget,
...
ARM_NONNULL(2)
arm_fsm_rt_t arm_2dp_cccn888_draw_point(arm_2d_op_drw_pt_t *ptOP, const arm_2d_tile_t *ptTarget,
        ...
        switch (OP_CORE.ptOp->Info.Colour.u3ColourSZ)
        {
            case ARM_2D_COLOUR_SZ_8BIT:
                __ARM_2D_PIXEL_BLENDING_OPA_GRAY8(
                    &this.chColour, (uint8_t *)ptTask->Param.tTileProcess.pBuffer, this.chOpaicty);
                break;
            case ARM_2D_COLOUR_SZ_16BIT:
                __ARM_2D_PIXEL_BLENDING_OPA_RGB565(
                    &this.hwColour, (uint16_t *)ptTask->Param.tTileProcess.pBuffer, this.chOpaicty);
                break;
            case ARM_2D_COLOUR_SZ_32BIT:
                __ARM_2D_PIXEL_BLENDING_OPA_CCCN888(
                    &this.wColour, (uint32_t *)ptTask->Param.tTileProcess.pBuffer, this.chOpaicty);
                break;
            default:
                return (arm_fsm_rt_t)ARM_2D_ERR_NOT_SUPPORT;
        }
 ...
 */
ARM_NONNULL(2)
arm_fsm_rt_t arm_2dp_c8bit_fill_colour(arm_2d_op_fill_cl_t *ptOP, const arm_2d_tile_t *ptTarget,
 ...
 */
ARM_NONNULL(2)
arm_fsm_rt_t arm_2dp_rgb16_fill_colour(arm_2d_op_fill_cl_t *ptOP, const arm_2d_tile_t *ptTarget,
 ...
 */
ARM_NONNULL(2)
arm_fsm_rt_t arm_2dp_rgb32_fill_colour(arm_2d_op_fill_cl_t *ptOP, const arm_2d_tile_t *ptTarget,
 ...
 */
ARM_NONNULL(2, 3)
arm_fsm_rt_t arm_2dp_c8bit_draw_pattern(arm_2d_op_drw_patn_t *ptOP, const arm_2d_tile_t *ptPattern,
                                        const arm_2d_tile_t   *ptTarget,
                                        const arm_2d_region_t *ptRegion, uint32_t wMode,
                                        uint8_t chForeColour, uint8_t chBackColour)
{
    B_ASSERT(NULL != ptPattern);
    B_ASSERT(NULL != ptTarget);

    ARM_2D_IMPL(arm_2d_op_drw_patn_t, ptOP);

    if ((wMode & (ARM_2D_DRW_PATN_MODE_NO_FG_COLOR | ARM_2D_DRW_PATH_MODE_COMP_FG_COLOUR |
 ...
 */
ARM_NONNULL(2, 3)
arm_fsm_rt_t arm_2dp_rgb16_draw_pattern(arm_2d_op_drw_patn_t *ptOP, const arm_2d_tile_t *ptPattern,
                                        const arm_2d_tile_t   *ptTarget,
                                        const arm_2d_region_t *ptRegion, uint32_t wMode,
                                        uint16_t hwForeColour, uint16_t hwBackColour)
{
    B_ASSERT(NULL != ptPattern);
    B_ASSERT(NULL != ptTarget);
 ...
 */
ARM_NONNULL(2, 3)
arm_fsm_rt_t arm_2dp_rgb32_draw_pattern(arm_2d_op_drw_patn_t *ptOP, const arm_2d_tile_t *ptPattern,
                                        const arm_2d_tile_t   *ptTarget,
                                        const arm_2d_region_t *ptRegion, uint32_t wMode,
                                        uint32_t wForeColour, uint32_t wBackColour)
{
...
arm_fsm_rt_t __arm_2d_c8bit_sw_draw_pattern(__arm_2d_sub_task_t *ptTask)
{
    ...
    else
    {
        ...
        __arm_2d_impl_c8bit_draw_pattern(
            ptTask->Param.tCopy.tSource.pBuffer, ptTask->Param.tCopy.tSource.nOffset,
            ptTask->Param.tCopy.tSource.iStride, ptTask->Param.tCopy.tTarget.pBuffer,
            ptTask->Param.tCopy.tTarget.iStride, &ptTask->Param.tCopy.tCopySize, wMode,
            this.Foreground.hwColour, this.Background.hwColour);
    }
...
arm_fsm_rt_t __arm_2d_rgb32_sw_draw_pattern(__arm_2d_sub_task_t *ptTask)
{
    ...
    else
    {
        __arm_2d_impl_rgb32_draw_pattern(
            ...
            ptTask->Param.tCopy.tSource.iStride, ptTask->Param.tCopy.tTarget.pBuffer,
            ptTask->Param.tCopy.tTarget.iStride, &ptTask->Param.tCopy.tCopySize, wMode,
            this.Foreground.wColour, this.Background.wColour);
    }
