 ...
 */
ARM_NONNULL(1, 2)
bool arm_2d_region_intersect(const arm_2d_region_t *ptRegionIn0, const arm_2d_region_t *ptRegionIn1,
                             arm_2d_region_t *ptRegionOut)
{
    B_ASSERT(ptRegionIn0 != NULL);
    B_ASSERT(ptRegionIn1 != NULL);

    do
    {
        arm_2d_location_t tLocationIn0End = {
            .iX = ptRegionIn0->tLocation.iX + ptRegionIn0->tSize.iWidth - 1,
            .iY = ptRegionIn0->tLocation.iY + ptRegionIn0->tSize.iHeight - 1,
        };

        arm_2d_location_t tLocationIn1End = {
            .iX = ptRegionIn1->tLocation.iX + ptRegionIn1->tSize.iWidth - 1,
            .iY = ptRegionIn1->tLocation.iY + ptRegionIn1->tSize.iHeight - 1,
        };

        arm_2d_location_t tLocationOutStart = {
            .iX = MAX(ptRegionIn0->tLocation.iX, ptRegionIn1->tLocation.iX),

            .iY = MAX(ptRegionIn0->tLocation.iY, ptRegionIn1->tLocation.iY),
        };

        arm_2d_location_t tLocationOutEnd = {
            .iX = MIN(tLocationIn0End.iX, tLocationIn1End.iX),
            .iY = MIN(tLocationIn0End.iY, tLocationIn1End.iY),
        };
...
{
    B_ASSERT(ptRegion != NULL);
    B_ASSERT(ptPoint != NULL);
...
const arm_2d_tile_t *__arm_2d_tile_get_1st_derived_child_or_root(
    const arm_2d_tile_t *ptTile, arm_2d_region_t *ptValidRegion, arm_2d_location_t *ptOffset,
    arm_2d_tile_t **ppFirstDerivedChild, bool bQuitWhenFindFirstDerivedChild)
{
    B_ASSERT(NULL != ptTile);
    B_ASSERT(NULL != ptValidRegion);
    ...
    *ptValidRegion = ptTile->tRegion;
    ...
    do
    {
        ...
        if (!arm_2d_region_intersect(&tParentRegion, ptValidRegion, ptValidRegion))
        {
            /* out of range */
            return NULL;
        }
...
{
    return __arm_2d_tile_get_1st_derived_child_or_root(ptTile, ptValidRegion, ptOffset,
                                                       ppFirstDerivedChild, false);
}
...
const arm_2d_tile_t *arm_2d_tile_get_root(const arm_2d_tile_t *ptTile,
                                          ...
                                          arm_2d_location_t   *ptOffset)
{
    return __arm_2d_tile_get_1st_derived_child_or_root(ptTile, ptValidRegion, ptOffset, NULL,
                                                       false);
}
...
{
    B_ASSERT(ptTarget != NULL);
    B_ASSERT(ptReference != NULL);
                                         ...
                                         arm_2d_region_t     *ptBuffer)
{
    ...
    B_ASSERT(NULL != ptReference);
    B_ASSERT(NULL != ptBuffer);

    //! get the absolute location
    arm_2d_location_t tTargetAbsoluteLocaton, tReferenceAbsoluteLocation;

    ptBuffer->tSize.iWidth  = ptTarget->tRegion.tSize.iWidth - ptReference->tRegion.tSize.iWidth;
    ptBuffer->tSize.iHeight = ptTarget->tRegion.tSize.iHeight - ptReference->tRegion.tSize.iHeight;
    ...
    ptBuffer->tLocation.iX = tTargetAbsoluteLocaton.iX - tReferenceAbsoluteLocation.iX;
    ptBuffer->tLocation.iY = tTargetAbsoluteLocaton.iY - tReferenceAbsoluteLocation.iY;
 ...
 */
ARM_NONNULL(1, 2, 3)
arm_2d_tile_t *arm_2d_tile_generate_child(const arm_2d_tile_t   *ptParentTile,
                                          const arm_2d_region_t *ptRegion, arm_2d_tile_t *ptOutput,
                                          bool bClipRegion)
{
    B_ASSERT(NULL != ptParentTile);
    B_ASSERT(NULL != ptRegion);
    B_ASSERT(NULL != ptOutput);
    ...
    if (bClipRegion)
    {
        if (!arm_2d_region_intersect(&tParentRegion, &(ptOutput->tRegion), &(ptOutput->tRegion)))
        {
            /* out of range */
            return NULL;
        }
    ...
    else
    {
         ...
         *!       below.
         */
        if (!arm_2d_region_intersect(&tParentRegion, &(ptOutput->tRegion),
...
ARM_NONNULL(2, 3)
arm_fsm_rt_t arm_2dp_c8bit_tile_copy(arm_2d_op_cp_t *ptOP, const arm_2d_tile_t *ptSource,
...
ARM_NONNULL(2, 3)
arm_fsm_rt_t arm_2dp_rgb16_tile_copy(arm_2d_op_cp_t *ptOP, const arm_2d_tile_t *ptSource,
                                     const arm_2d_tile_t *ptTarget, const arm_2d_region_t *ptRegion,
                                     uint32_t wMode)
{
    B_ASSERT(NULL != ptSource);
...
ARM_NONNULL(2, 3)
arm_fsm_rt_t arm_2dp_rgb32_tile_copy(arm_2d_op_cp_t *ptOP, const arm_2d_tile_t *ptSource,
                                     const arm_2d_tile_t *ptTarget, const arm_2d_region_t *ptRegion,
                                     uint32_t wMode)
{
...
arm_fsm_rt_t __arm_2d_c8bit_sw_tile_copy(__arm_2d_sub_task_t *ptTask)
{
    ...
    B_ASSERT(ARM_2D_COLOUR_SZ_8BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);

    uint32_t wMode = this.wMode;

    if (wMode & (ARM_2D_CP_MODE_Y_MIRROR | ARM_2D_CP_MODE_X_MIRROR))
    {
        __arm_2d_impl_c8bit_copy_mirror(
            ...
            &ptTask->Param.tCopy.tCopySize, wMode);
    }
    else
    {
...
{
    ARM_2D_IMPL(arm_2d_op_cp_t, ptTask->ptOP);
    B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_c8bit_sw_tile_fill(__arm_2d_sub_task_t *ptTask)
{
    ...
    if (wMode & (ARM_2D_CP_MODE_Y_MIRROR | ARM_2D_CP_MODE_X_MIRROR))
    {
        ...
        __arm_2d_impl_c8bit_fill_mirror(
            ptTask->Param.tFill.tSource.pBuffer, ptTask->Param.tFill.tSource.iStride,
            &ptTask->Param.tFill.tSource.tValidRegion.tSize, ptTask->Param.tFill.tTarget.pBuffer,
            ptTask->Param.tFill.tTarget.iStride, &ptTask->Param.tFill.tTarget.tValidRegion.tSize,
            wMode);
    }
    else
    {
...
arm_fsm_rt_t arm_2dp_c8bit_tile_copy_with_colour_keying(arm_2d_op_cp_cl_key_t *ptOP,
                                                        ...
                                                        uint8_t chMaskColour, uint32_t wMode)
{
    B_ASSERT(NULL != ptSource);
    B_ASSERT(NULL != ptTarget);
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_COLOUR_KEYING_C8BIT;
...
arm_fsm_rt_t arm_2dp_rgb16_tile_copy_with_colour_keying(arm_2d_op_cp_cl_key_t *ptOP,
                                                        ...
                                                        const arm_2d_tile_t   *ptTarget,
                                                        const arm_2d_region_t *ptRegion,
                                                        uint16_t hwMaskColour, uint32_t wMode)
{
    B_ASSERT(NULL != ptSource);
    B_ASSERT(NULL != ptTarget);
    ...
    OP_CORE.ptOp = &ARM_2D_OP_TILE_COPY_WITH_COLOUR_KEYING_RGB16;
...
arm_fsm_rt_t arm_2dp_rgb32_tile_copy_with_colour_keying(arm_2d_op_cp_cl_key_t *ptOP,
                                                        ...
                                                        const arm_2d_tile_t   *ptTarget,
                                                        const arm_2d_region_t *ptRegion,
                                                        uint32_t wMaskColour, uint32_t wMode)
{
    B_ASSERT(NULL != ptSource);
    B_ASSERT(NULL != ptTarget);
...
arm_fsm_rt_t __arm_2d_c8bit_sw_tile_copy_with_colour_keying(__arm_2d_sub_task_t *ptTask)
{
    ...
    if (wMode & (ARM_2D_CP_MODE_Y_MIRROR | ARM_2D_CP_MODE_X_MIRROR))
    {
        ...
        __arm_2d_impl_c8bit_cl_key_copy_mirror(
            ptTask->Param.tCopy.tSource.pBuffer, ptTask->Param.tCopy.tSource.iStride,
            ptTask->Param.tCopy.tTarget.pBuffer, ptTask->Param.tCopy.tTarget.iStride,
            &ptTask->Param.tCopy.tCopySize, wMode, this.hwColour);
    }
    else
    {
...
arm_fsm_rt_t __arm_2d_rgb16_sw_tile_copy_with_colour_keying(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_cp_cl_key_t, ptTask->ptOP)
...
arm_fsm_rt_t __arm_2d_rgb32_sw_tile_copy_with_colour_keying(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_cp_cl_key_t, ptTask->ptOP)
    ...
    if (wMode & (ARM_2D_CP_MODE_Y_MIRROR | ARM_2D_CP_MODE_X_MIRROR))
    {
        ...
        __arm_2d_impl_rgb32_cl_key_copy_mirror(
            ptTask->Param.tCopy.tSource.pBuffer, ptTask->Param.tCopy.tSource.iStride,
            ptTask->Param.tCopy.tTarget.pBuffer, ptTask->Param.tCopy.tTarget.iStride,
            &ptTask->Param.tCopy.tCopySize, wMode, this.wColour);
    }
    else
    {
...
arm_fsm_rt_t __arm_2d_c8bit_sw_tile_fill_with_colour_keying(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_cp_cl_key_t, ptTask->ptOP);
    B_ASSERT(ARM_2D_COLOUR_SZ_8BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    uint32_t wMode = this.wMode;
...
arm_fsm_rt_t __arm_2d_rgb16_sw_tile_fill_with_colour_keying(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_cp_cl_key_t, ptTask->ptOP);
    B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    uint32_t wMode = this.wMode;
...
arm_fsm_rt_t __arm_2d_rgb32_sw_tile_fill_with_colour_keying(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_cp_cl_key_t, ptTask->ptOP);
    B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
#define __arm_2d_c8bit_sw_tile_copy_with_colour_keying_only \
    __arm_2d_c8bit_sw_tile_copy_with_colour_keying_and_only
#define __arm_2d_rgb16_sw_tile_copy_with_colour_keying_only \
    __arm_2d_rgb16_sw_tile_copy_with_colour_keying_and_only
#define __arm_2d_rgb32_sw_tile_copy_with_colour_keying_only \
    __arm_2d_rgb32_sw_tile_copy_with_colour_keying_and_only

#define arm_2dp_c8bit_tile_copy_with_colour_keying_and_only \
    arm_2dp_c8bit_tile_copy_with_colour_keying_only
#define arm_2dp_rgb16_tile_copy_with_colour_keying_and_only \
    arm_2dp_rgb16_tile_copy_with_colour_keying_only
#define arm_2dp_rgb32_tile_copy_with_colour_keying_and_only \
...
#define __arm_2d_c8bit_sw_tile_fill_with_colour_keying_only \
    __arm_2d_c8bit_sw_tile_fill_with_colour_keying_and_only
#define __arm_2d_rgb16_sw_tile_fill_with_colour_keying_only \
    __arm_2d_rgb16_sw_tile_fill_with_colour_keying_and_only
#define __arm_2d_rgb32_sw_tile_fill_with_colour_keying_only \
    __arm_2d_rgb32_sw_tile_fill_with_colour_keying_and_only

#define arm_2dp_c8bit_tile_fill_with_colour_keying_and_only \
    arm_2dp_c8bit_tile_fill_with_colour_keying_only
#define arm_2dp_rgb16_tile_fill_with_colour_keying_and_only \
    arm_2dp_rgb16_tile_fill_with_colour_keying_only
#define arm_2dp_rgb32_tile_fill_with_colour_keying_and_only \
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_X_MIRROR_C8BIT),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_X_MIRROR_RGB16),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_X_MIRROR_RGB32),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_Y_MIRROR_C8BIT),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_Y_MIRROR_RGB16),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_Y_MIRROR_RGB32),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_XY_MIRROR_C8BIT),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_XY_MIRROR_RGB16),
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_XY_MIRROR_RGB32),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_X_MIRROR_C8BIT),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_X_MIRROR_C8BIT),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_X_MIRROR_RGB16),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_X_MIRROR_RGB16),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_X_MIRROR_RGB32),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_X_MIRROR_RGB32),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_Y_MIRROR_C8BIT),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_Y_MIRROR_C8BIT),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_Y_MIRROR_RGB16),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_Y_MIRROR_RGB16),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_Y_MIRROR_RGB32),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_Y_MIRROR_RGB32),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_XY_MIRROR_C8BIT),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_XY_MIRROR_C8BIT),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_XY_MIRROR_RGB16),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_XY_MIRROR_RGB16),
                },
        },
};
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_COPY_WITH_COLOUR_MASKING_AND_XY_MIRROR_RGB32),
                    .ptFillLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_WITH_COLOUR_MASKING_AND_XY_MIRROR_RGB32),
                },
        },
};
