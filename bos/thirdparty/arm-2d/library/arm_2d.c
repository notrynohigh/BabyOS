 ...
 */
extern arm_2d_err_t __arm_2d_async_init(__arm_2d_sub_task_t *ptSubTasks, uint_fast16_t hwCount);
#endif
 ...
 */
extern void __arm_2d_helium_init(void);
#endif
 ...
 */
extern void __arm_2d_cde_init(void);
#endif
 ...
 */
extern void __arm_2d_acc_init(void);
#endif
...
void arm_2d_init(void)
{
    ...
    do
    {
        static __arm_2d_sub_task_t s_tDefaultTaskPool[__ARM_2D_CFG_DEFAULT_SUB_TASK_POOL_SIZE__];
...
void *__arm_2d_allocate_scratch_memory(uint32_t wSize, uint_fast8_t nAlign, arm_2d_mem_type_t tType)
{
    ...
    B_ASSERT((((~nAlign) + 1) & nAlign) == nAlign);

    void *pBuff = malloc(wSize);
    B_ASSERT(0 == ((uintptr_t)pBuff & (nAlign - 1)));
