...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_opacity(__arm_2d_sub_task_t *ptTask)
{
    ...
    if (255 == this.chRatio)
    {
        __arm_2d_impl_c8bit_colour_filling(
            ptTask->Param.tTileProcess.pBuffer, ptTask->Param.tTileProcess.iStride,
            &(ptTask->Param.tTileProcess.tValidRegion.tSize), this.chColour);
    }
    else
    {
        __arm_2d_impl_gray8_colour_filling_with_opacity(
            ptTask->Param.tTileProcess.pBuffer, ptTask->Param.tTileProcess.iStride,
            &(ptTask->Param.tTileProcess.tValidRegion.tSize), this.chColour, this.chRatio);
    }
    return arm_fsm_rt_cpl;
}

arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_opc_t, ptTask->ptOP)
    ...
    if (255 == this.chRatio)
    {
        __arm_2d_impl_rgb16_colour_filling(
            ptTask->Param.tTileProcess.pBuffer, ptTask->Param.tTileProcess.iStride,
            &(ptTask->Param.tTileProcess.tValidRegion.tSize), this.hwColour);
    }
    else
    {
        __arm_2d_impl_rgb565_colour_filling_with_opacity(
            ptTask->Param.tTileProcess.pBuffer, ptTask->Param.tTileProcess.iStride,
            &(ptTask->Param.tTileProcess.tValidRegion.tSize), this.hwColour, this.chRatio);
    }

    return arm_fsm_rt_cpl;
}

arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_opc_t, ptTask->ptOP)
    ...
    if (255 == this.chRatio)
    {
        __arm_2d_impl_rgb32_colour_filling(
            ptTask->Param.tTileProcess.pBuffer, ptTask->Param.tTileProcess.iStride,
            &(ptTask->Param.tTileProcess.tValidRegion.tSize), this.wColour);
    }
    else
    {
        __arm_2d_impl_cccn888_colour_filling_with_opacity(
            ptTask->Param.tTileProcess.pBuffer, ptTask->Param.tTileProcess.iStride,
            &(ptTask->Param.tTileProcess.tValidRegion.tSize), this.wColour, this.chRatio);
    }
...
{
    B_ASSERT(NULL != ptTarget);
    B_ASSERT(NULL != ptAlpha);

    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptOP);

    //! valid alpha mask tile
    if (!__arm_2d_valid_mask(ptAlpha, __ARM_2D_MASK_ALLOW_A8
...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_mask(__arm_2d_sub_task_t *ptTask)
{
...
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_a2_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    ...
    __arm_2d_impl_gray8_colour_filling_a2_mask(
        ...
        ptTask->Param.tCopy.tSource.pBuffer,  //!< alpha tile
        ptTask->Param.tCopy.tSource.iStride,  //!< alpha tile
        ptTask->Param.tCopy.tSource.nOffset, &(ptTask->Param.tCopy.tCopySize), this.chColour);

    return arm_fsm_rt_cpl;
}

arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_a2_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    ...
    __arm_2d_impl_rgb565_colour_filling_a2_mask(
        ...
        ptTask->Param.tCopy.tSource.pBuffer,  //!< alpha tile
        ptTask->Param.tCopy.tSource.iStride,  //!< alpha tile
        ptTask->Param.tCopy.tSource.nOffset, &(ptTask->Param.tCopy.tCopySize), this.hwColour);

    return arm_fsm_rt_cpl;
}

arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_a2_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    ...
    __arm_2d_impl_cccn888_colour_filling_a2_mask(
        ...
        ptTask->Param.tCopy.tSource.pBuffer,  //!< alpha tile
        ptTask->Param.tCopy.tSource.iStride,  //!< alpha tile
        ptTask->Param.tCopy.tSource.nOffset, &(ptTask->Param.tCopy.tCopySize), this.wColour);
...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_a4_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_a4_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_a4_mask(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_fill_cl_msk_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t arm_2dp_gray8_fill_colour_with_a2_mask_and_opacity(
    arm_2d_op_alpha_fill_cl_msk_opc_t *ptOP, const arm_2d_tile_t *ptTarget,
    const arm_2d_region_t *ptRegion, const arm_2d_tile_t *ptAlpha, arm_2d_color_gray8_t tColour,
    uint8_t chOpacity)
{
    B_ASSERT(NULL != ptTarget);
    B_ASSERT(NULL != ptAlpha);
...
arm_fsm_rt_t arm_2dp_rgb565_fill_colour_with_a2_mask_and_opacity(
    arm_2d_op_alpha_fill_cl_msk_opc_t *ptOP, const arm_2d_tile_t *ptTarget,
    const arm_2d_region_t *ptRegion, const arm_2d_tile_t *ptAlpha, arm_2d_color_rgb565_t tColour,
    uint8_t chOpacity)
{
    B_ASSERT(NULL != ptTarget);
    B_ASSERT(NULL != ptAlpha);
...
arm_fsm_rt_t arm_2dp_cccn888_fill_colour_with_a2_mask_and_opacity(
    arm_2d_op_alpha_fill_cl_msk_opc_t *ptOP, const arm_2d_tile_t *ptTarget,
    const arm_2d_region_t *ptRegion, const arm_2d_tile_t *ptAlpha, arm_2d_color_cccn888_t tColour,
    uint8_t chOpacity)
{
    B_ASSERT(NULL != ptTarget);
    B_ASSERT(NULL != ptAlpha);
...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_a2_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
...
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_a2_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_alpha_fill_cl_msk_opc_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_a4_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_alpha_fill_cl_msk_opc_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_a4_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_alpha_fill_cl_msk_opc_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
...
arm_fsm_rt_t __arm_2d_gray8_sw_colour_filling_with_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_alpha_fill_cl_msk_opc_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    ...
    if (ARM_2D_CHANNEL_8in32 == ptTask->Param.tCopy.tSource.tColour.chScheme)
    {
        ...
        else
        {
            __arm_2d_impl_gray8_colour_filling_channel_mask_opacity(
                ...
                ptTask->Param.tCopy.tSource.pBuffer,  //!< alpha tile
                ptTask->Param.tCopy.tSource.iStride,  //!< alpha tile
                &(ptTask->Param.tCopy.tCopySize), this.chColour, this.chRatio);
        }
#endif
    }
    else
...
arm_fsm_rt_t __arm_2d_rgb565_sw_colour_filling_with_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_alpha_fill_cl_msk_opc_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_16BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    ...
    if (ARM_2D_CHANNEL_8in32 == ptTask->Param.tCopy.tSource.tColour.chScheme)
    {
        ...
        else
        {
            __arm_2d_impl_rgb565_colour_filling_channel_mask_opacity(
                ...
                ptTask->Param.tCopy.tSource.pBuffer,  //!< alpha tile
                ptTask->Param.tCopy.tSource.iStride,  //!< alpha tile
                &(ptTask->Param.tCopy.tCopySize), this.hwColour, this.chRatio);
        }
#endif
    }
    else
...
arm_fsm_rt_t __arm_2d_cccn888_sw_colour_filling_with_mask_and_opacity(__arm_2d_sub_task_t *ptTask)
{
    ARM_2D_IMPL(arm_2d_op_alpha_fill_cl_msk_opc_t, ptTask->ptOP)
    // B_ASSERT(ARM_2D_COLOUR_SZ_32BIT == OP_CORE.ptOp->Info.Colour.u3ColourSZ);
    ...
    if (ARM_2D_CHANNEL_8in32 == ptTask->Param.tCopy.tSource.tColour.chScheme)
    {
        ...
        else
        {
            __arm_2d_impl_cccn888_colour_filling_channel_mask_opacity(
                ...
                ptTask->Param.tCopy.tSource.pBuffer,  //!< alpha tile
                ptTask->Param.tCopy.tSource.iStride,  //!< alpha tile
                &(ptTask->Param.tCopy.tCopySize), this.wColour, this.chRatio);
        }
#endif
    }
    else
...
__WEAK
def_low_lv_io(__ARM_2D_IO_FILL_COLOUR_A2_MASK_GRAY8, __arm_2d_gray8_sw_colour_filling_with_a2_mask);
__WEAK
...
__WEAK
def_low_lv_io(__ARM_2D_IO_FILL_COLOUR_A4_MASK_GRAY8, __arm_2d_gray8_sw_colour_filling_with_a4_mask);
__WEAK
...
__WEAK
def_low_lv_io(__ARM_2D_IO_FILL_COLOUR_MASK_GRAY8, __arm_2d_gray8_sw_colour_filling_with_mask);
__WEAK
def_low_lv_io(__ARM_2D_IO_FILL_COLOUR_MASK_RGB565, __arm_2d_rgb565_sw_colour_filling_with_mask);
__WEAK
def_low_lv_io(__ARM_2D_IO_FILL_COLOUR_MASK_CCCN888, __arm_2d_cccn888_sw_colour_filling_with_mask);
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_COLOUR_A2_MASK_AND_OPACITY_CCCN888),
                    .ptFillLike = NULL,
                },
        },
};
    ...
    .Info =
        {
            ...
            .LowLevelIO =
                {
                    .ptCopyLike =
                        ref_low_lv_io(__ARM_2D_IO_FILL_COLOUR_A4_MASK_AND_OPACITY_CCCN888),
                    .ptFillLike = NULL,
                },
        },
};
