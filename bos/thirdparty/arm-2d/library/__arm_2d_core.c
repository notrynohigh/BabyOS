                                            ...
                                            __arm_2d_tile_param_t *ptParam)
{
    ...
    intptr_t nAddress = (ptVRES->Load)(ptVRES->pTarget, ptVRES, &ptParam->tValidRegion);
    ...
    if ((0 != ptVRES->tTile.tColourInfo.chScheme) && (ptVRES->tTile.tColourInfo.u3ColourSZ < 3))
    {
...
static void __depose_virtual_resource(const arm_2d_tile_t *ptSourceTile)
{
    ...
    ptSourceTile = __arm_2d_tile_get_root(ptSourceTile, &tValidRegion, NULL, NULL);
...
void __arm_2d_sub_task_depose(arm_2d_op_core_t *ptOP)
{
    ...
    {
        case ARM_2D_OP_INFO_PARAM_HAS_TARGET | ARM_2D_OP_INFO_PARAM_HAS_TARGET_MASK:
        {
        ...
        case ARM_2D_OP_INFO_PARAM_HAS_TARGET | ARM_2D_OP_INFO_PARAM_HAS_SOURCE:
        {
        ...
        case ARM_2D_OP_INFO_PARAM_HAS_TARGET | ARM_2D_OP_INFO_PARAM_HAS_SOURCE |
            ARM_2D_OP_INFO_PARAM_HAS_TARGET_MASK | ARM_2D_OP_INFO_PARAM_HAS_SOURCE_MASK:
        {
        ...
        case ARM_2D_OP_INFO_PARAM_HAS_TARGET | ARM_2D_OP_INFO_PARAM_HAS_ORIGIN |
            ARM_2D_OP_INFO_PARAM_HAS_SOURCE | ARM_2D_OP_INFO_PARAM_HAS_SOURCE_MASK:
        case ARM_2D_OP_INFO_PARAM_HAS_TARGET | ARM_2D_OP_INFO_PARAM_HAS_ORIGIN |
            ARM_2D_OP_INFO_PARAM_HAS_SOURCE | ARM_2D_OP_INFO_PARAM_HAS_TARGET_MASK:
        case ARM_2D_OP_INFO_PARAM_HAS_TARGET | ARM_2D_OP_INFO_PARAM_HAS_ORIGIN |
            ARM_2D_OP_INFO_PARAM_HAS_SOURCE | ARM_2D_OP_INFO_PARAM_HAS_TARGET_MASK |
            ARM_2D_OP_INFO_PARAM_HAS_SOURCE_MASK:
        {
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_tile_process(arm_2d_op_t           *ptThis,
                                                  __arm_2d_tile_param_t *ptParam)
{
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_fill(arm_2d_op_cp_t *ptThis, __arm_2d_tile_param_t *ptSource,
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_fill_with_mask(arm_2d_op_cp_t        *ptThis,
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_copy(arm_2d_op_cp_t *ptThis, __arm_2d_tile_param_t *ptSource,
                                          __arm_2d_tile_param_t    *ptTarget,
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_copy_with_mask(arm_2d_op_cp_t           *ptThis,
                                                    __arm_2d_tile_param_t    *ptSource,
                                                    __arm_2d_tile_param_t    *ptSourceMask,
                                                    __arm_2d_tile_param_t    *ptTarget,
                                                    __arm_2d_tile_param_t    *ptTargetMask,
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_fill_origin(arm_2d_op_cp_t        *ptThis,
                                                 __arm_2d_tile_param_t *ptSource,
...
__WEAK
arm_fsm_rt_t __arm_2d_issue_sub_task_copy_origin(arm_2d_op_cp_t           *ptThis,
                                                 __arm_2d_tile_param_t    *ptSource,
                                                 __arm_2d_tile_param_t    *ptOrigin,
                                                 __arm_2d_tile_param_t    *ptTarget,
                                                 arm_2d_size_t *__RESTRICT ptCopySize)
...
arm_fsm_rt_t __arm_2d_issue_sub_task_copy_origin_masks(
    arm_2d_op_cp_t *ptThis, __arm_2d_tile_param_t *ptSource, __arm_2d_tile_param_t *ptOrigin,
    __arm_2d_tile_param_t *ptOriginMask, __arm_2d_tile_param_t *ptTarget,
    __arm_2d_tile_param_t *ptTargetMask, arm_2d_size_t *__RESTRICT ptCopySize)
{
    arm_fsm_rt_t         tResult = (arm_fsm_rt_t)ARM_2D_ERR_NOT_SUPPORT;
    __arm_2d_sub_task_t *ptTask  = &(__arm_2d_sub_task_t){
         .ptOP = (arm_2d_op_core_t *)ptThis,
...
ARM_NONNULL(1, 2)
static const arm_2d_tile_t *__arm_2d_tile_region_caculator(const arm_2d_tile_t   *ptTile,
                                                           ...
                                                           uint32_t wMode)
{
    ...
    B_ASSERT(NULL != ptTile);
    B_ASSERT(NULL != ptOut);

    // memset(ptOut, 0, sizeof(__arm_2d_tile_param_t));

    ptTile = __arm_2d_tile_get_root(ptTile, &tValidRegion, NULL, &ptOut->ptDerivedResource);
    ...
    if (NULL != ptTile)
    {
        ...
        if (chPixelLenInBit >= 8)
        {
            ...
            pchBuffer = ptTile->pchBuffer + (nOffset * chPixelLenInBit >> 3);
        }
        else
        {
            ...
            pchBuffer = ptTile->pchBuffer +
                        ((ptTile->tRegion.tSize.iWidth * chPixelLenInBit + 7) >> 3) * tOffset.iY +
...
ARM_NONNULL(1, 2)
static arm_fsm_rt_t __arm_2d_tile_process(arm_2d_op_t *ptThis, const arm_2d_tile_t *ptTarget)
{
    B_ASSERT(NULL != ptTarget);
    B_ASSERT(OP_CORE.ptOp->Info.Colour.u3ColourSZ >= ARM_2D_COLOUR_SZ_8BIT);
    ...
    __arm_2d_tile_region_caculator(ptTarget, &tTileParam, &chPixelLenInBit,
                                   OP_CORE.ptOp->Info.Param.bAllowEnforcedColour, 0);
...
static void __arm_2d_source_side_tile_mirror_preprocess(const arm_2d_tile_t   *ptTile,
                                                        ...
                                                        uint32_t               wMode)
{
    ...
    if (ptTileParam->bDerivedResource)
    {
        ...
        if (wMode & ARM_2D_CP_MODE_X_MIRROR)
        {
            ...
            tOffset.iX += (ptTileParam->ptDerivedResource->tRegion.tLocation.iX +
                          ...
                          (ptTileParam->tValidRegion.tLocation.iX + ptActualSize->iWidth);
        ...
        if (wMode & ARM_2D_CP_MODE_Y_MIRROR)
        {
            ...
            tOffset.iY += (ptTileParam->ptDerivedResource->tRegion.tLocation.iY +
                          ...
                          (ptTileParam->tValidRegion.tLocation.iY + ptActualSize->iHeight);
    ...
    if (chPixelLenInBit >= 8)
    {
        ...
        ptTileParam->nOffset += (tOffset.iY * ptTile->tRegion.tSize.iWidth + tOffset.iX);

        ptTileParam->pBuffer = ptTile->pchBuffer + (ptTileParam->nOffset * chPixelLenInBit >> 3);
    }
    else
    {
...
ARM_NONNULL(1, 2)
static arm_fsm_rt_t __arm_2d_region_calculator(arm_2d_op_cp_t      *ptThis,
                                               const arm_2d_tile_t *ptSource,
                                               const arm_2d_tile_t *ptSourceMask,
                                               const arm_2d_tile_t *ptTarget,
                                               const arm_2d_tile_t *ptTargetMask, uint32_t wMode)
{
    ...
    if (OP_CORE.ptOp->Info.Param.bHasOrigin)
    {
        ...
        ptOrigin = __arm_2d_tile_region_caculator(
            ptOP->Origin.ptTile, &tOriginTileParam, &chOriginPixelLenInBit,
            OP_CORE.ptOp->Info.Param.bAllowEnforcedColour, wMode);
    ...
    ptSource = __arm_2d_tile_region_caculator(ptSource, &tSourceTileParam, &chSourcePixelLenInBit,
                                              OP_CORE.ptOp->Info.Param.bAllowEnforcedColour, wMode);

    ptTarget = __arm_2d_tile_region_caculator(ptTarget, &tTargetTileParam, &chTargetPixelLenInBit,
                                              false, 0);
    ...
    {  //!< no origin
        if (OP_CORE.ptOp->Info.Param.bHasSrcMask)
        {
            ...
            ptSourceMask =
                arm_2d_tile_get_root(ptOP->Mask.ptSourceSide, &tSourceMaskParam.tValidRegion, NULL);

            if (NULL != ptSourceMask)
            {
                ptSourceMask = arm_2d_tile_generate_child(
                    ptSourceMask, &tSourceTileParam.tValidRegion, &tSourceMask, false);

                ptSourceMask = __arm_2d_tile_region_caculator(
                    ptSourceMask, &tSourceMaskParam, &chSourceMaskPixelLenInBit, true, wMode);
            }
        }
        ...
        if (OP_CORE.ptOp->Info.Param.bHasDesMask)
        {
            ...
            ptTargetMask =
                arm_2d_tile_get_root(ptOP->Mask.ptTargetSide, &tTargetMaskParam.tValidRegion, NULL);
            ...
            if (NULL != ptTargetMask)
            {
                ...
                do
                {
                    ...
                    arm_2d_get_absolute_location(ptThis->Target.ptTile, &tTempRegion.tLocation);

                    tTempRegion.tLocation.iX =
                        tTargetTileParam.tValidRegion.tLocation.iX - tTempRegion.tLocation.iX;

                    tTempRegion.tSize.iWidth =
                        tTargetTileParam.tValidRegion.tSize.iWidth - tTempRegion.tSize.iWidth;
                    ...
                    if (ptTargetMask->tRegion.tSize.iHeight != 1)
                    {
                        tTempRegion.tLocation.iY =
                            tTargetTileParam.tValidRegion.tLocation.iY - tTempRegion.tLocation.iY;

                        tTempRegion.tSize.iHeight =
                            tTargetTileParam.tValidRegion.tSize.iHeight - tTempRegion.tSize.iHeight;

                        tNewTargetMaskRegion.tLocation.iY += tTempRegion.tLocation.iY;
                        tNewTargetMaskRegion.tSize.iHeight += tTempRegion.tSize.iHeight;
                    }

                    ptTargetMask = arm_2d_tile_generate_child(ptTargetMask, &tNewTargetMaskRegion,
                                                              &tTargetMask, false);

                } while (0);

                ptTargetMask = __arm_2d_tile_region_caculator(ptTargetMask, &tTargetMaskParam,
                                                              &chTargetMaskPixelLenInBit, true, 0);
            }
        }
    }
    else
    {  //!< has origin
        if (OP_CORE.ptOp->Info.Param.bHasSrcMask)
        {
            ...
            ptSourceMask =
                arm_2d_tile_get_root(ptOP->Mask.ptOriginSide, &tSourceMaskParam.tValidRegion, NULL);

            if (NULL != ptSourceMask)
            {
                ptSourceMask = arm_2d_tile_generate_child(
                    ptSourceMask, &tOriginTileParam.tValidRegion, &tSourceMask, false);
    ...
    {  //!< tiling (tile fill) operation

        if (OP_CORE.ptOp->Info.Param.bHasOrigin)
        {
            /*! \brief masks are not supported in fill with origin mode */
            B_ASSERT(!OP_CORE.ptOp->Info.Param.bHasSrcMask);
            B_ASSERT(!OP_CORE.ptOp->Info.Param.bHasDesMask);

            //! handle mirroring
            do
            {
                __arm_2d_source_side_tile_mirror_preprocess(
                    ptOrigin, &tOriginTileParam, chOriginPixelLenInBit,
                    &tOriginTileParam.tValidRegion.tSize, wMode);

                if (OP_CORE.ptOp->Info.Param.bHasSrcMask && (NULL != ptSourceMask))
                {
                    ...
                    __arm_2d_source_side_tile_mirror_preprocess(
                        ptSourceMask, &tSourceMaskParam, chSourceMaskPixelLenInBit,
                        &tSourceMaskParam.tValidRegion.tSize, wMode);
                }
            ...
            do
            {
                arm_2d_err_t tErr = __load_virtual_resource(ptOrigin, &tOriginTileParam);
            ...
            tResult = __arm_2d_issue_sub_task_fill_origin(ptThis, &tSourceTileParam,
                                                          &tOriginTileParam, &tTargetTileParam);
        }
        else
        {
            ...
            {
                __arm_2d_source_side_tile_mirror_preprocess(
                    ptSource, &tSourceTileParam, chSourcePixelLenInBit,
                    &tSourceTileParam.tValidRegion.tSize, wMode);
            ...
            do
            {
                arm_2d_err_t tErr = __load_virtual_resource(ptSource, &tSourceTileParam);
                if (tErr != ARM_2D_ERR_NONE)
                {
                    return (arm_fsm_rt_t)tErr;
                }
            ...
            if ((OP_CORE.ptOp->Info.Param.bHasSrcMask) || (OP_CORE.ptOp->Info.Param.bHasDesMask))
            {

                tResult = __arm_2d_issue_sub_task_fill_with_mask(
                    ptThis, &tSourceTileParam, ((NULL != ptSourceMask) ? &tSourceMaskParam : NULL),
                    &tTargetTileParam, ((NULL != ptTargetMask) ? &tTargetMaskParam : NULL));
            }
            else
            {
                tResult =
                    __arm_2d_issue_sub_task_fill(ptThis, &tSourceTileParam, &tTargetTileParam);
            }
        }
    }
    else
    {  //!< normal tile copy operation
        ...
        if (OP_CORE.ptOp->Info.Param.bHasOrigin)
        {
            ...
            if ((OP_CORE.ptOp->Info.Param.bHasSrcMask) || (OP_CORE.ptOp->Info.Param.bHasDesMask))
            {
                tResult = __arm_2d_issue_sub_task_copy_origin_masks(
                    ptThis, &tSourceTileParam, &tOriginTileParam,
                    ((NULL != ptSourceMask) ? &tSourceMaskParam : NULL), &tTargetTileParam,
                    ((NULL != ptTargetMask) ? &tTargetMaskParam : NULL), &tActualSize);
            }
            else
            {
                tResult = __arm_2d_issue_sub_task_copy_origin(
                    ptThis, &tSourceTileParam, &tOriginTileParam, &tTargetTileParam, &tActualSize);
            }
        }
        else
        {
            ...
            {
                tResult = __arm_2d_issue_sub_task_copy(ptThis, &tSourceTileParam, &tTargetTileParam,
                                                       &tActualSize);
            }
        }
    }
...
static arm_fsm_rt_t __tile_clipped_pave(arm_2d_op_cp_t *ptThis, const arm_2d_tile_t *ptTarget,
                                        const arm_2d_region_t *ptRegion,
                                        arm_2d_region_t *ptClippedRegion, uint32_t wMode)
{
    ...
    do
    {
        ...
        if (NULL ==
            arm_2d_tile_generate_child(this.Source.ptTile, &tempRegion, &tTempSourceTile, true))
        {
            break;
        };
        ...
        if (NULL ==
            arm_2d_tile_generate_child(  // this.use_as__arm_2d_op_core_t.Runtime.ptTargetTile,
                ptTarget, ptRegion, &tTargetTile, true))
        {
            break;
        }
        ...
        {
            tResult = __arm_2d_region_calculator(ptThis, &tTempSourceTile,
                                                 NULL,  //!< source mask
                                                 &tTargetTile,
                                                 NULL,  //!< target mask
                                                 wMode);
...
static arm_fsm_rt_t __tile_non_negtive_location_pave(arm_2d_op_cp_t        *ptThis,
                                                     const arm_2d_tile_t   *ptSource,
                                                     const arm_2d_tile_t   *ptTarget,
                                                     const arm_2d_region_t *ptRegion,
                                                     uint32_t               wMode)
{
    ...
    do
    {
        ...
        if (OP_CORE.ptOp->Info.Colour.u3ColourSZ >= ARM_2D_COLOUR_SZ_8BIT)
        {
            tResult = __arm_2d_region_calculator(ptThis, ptSource,
                                                 NULL,  //!< source mask
                                                 &tTile,
                                                 NULL,  //!< target mask
                                                 wMode);
...
__WEAK
bool __arm_2d_op_ensure_resource(arm_2d_op_core_t *ptOP, uint_fast16_t hwRequired)
{
...
static arm_fsm_rt_t __arm_2d_op_frontend_region_process(arm_2d_op_core_t *ptOP)
{
    ...
    do
    {
        ...
        ptTarget = arm_2d_tile_generate_child(this.Target.ptTile, &tValidRegion, &tTile, true);
        //! [Modify][Target.ptTile]
        // B_ASSERT(NULL != this.Target.ptTile);
        // B_ASSERT(NULL != this.use_as__arm_2d_op_core_t.Runtime.ptTargetTile);
        B_ASSERT(NULL != ptTarget);
    ...
    if (!arm_2d_region_intersect(&tDrawRegion, &tTargetRegion, &tDrawRegion))
    {
        return (arm_fsm_rt_t)ARM_2D_ERR_OUT_OF_REGION;
    }
    ...
    do
    {
        ...
        if (NULL == arm_2d_tile_generate_child(
                        // this.use_as__arm_2d_op_core_t.Runtime.ptTargetTile,
                        ptTarget, &tTargetRegion, &tTempTile, true))
        {
            break;
        }
#if 0
        ...
        if (OP_CORE.ptOp->Info.Colour.u3ColourSZ >= ARM_2D_COLOUR_SZ_8BIT)
        {
            tResult = __arm_2d_tile_process(ptThis, &tTempTile);
        }
        else
        {
            tResult = (arm_fsm_rt_t)ARM_2D_ERR_NOT_SUPPORT;
...
static arm_fsm_rt_t __arm_2d_op_frontend_control(arm_2d_op_core_t *ptOP)
{
    /*TODO: add support for control operations*/
    return (arm_fsm_rt_t)ARM_2D_ERR_NOT_SUPPORT;
}

static arm_fsm_rt_t __arm_2d_op_frontend_region_process_with_src(arm_2d_op_core_t *ptOP)
{
    ...
    if ((tTargetRegion.tLocation.iX < 0) || (tTargetRegion.tLocation.iY < 0))
    {
        ...
        tResult = __tile_clipped_pave(&this, ptTarget, &tTargetRegion, &tClippdRegion,
        ...
        { /*!< fill mode */
            ...
            */
            ...
            if (tClippdRegion.tSize.iWidth < tDrawRegion.tSize.iWidth)
            {
                ...
                tHeaderRegion.tSize.iWidth = tDrawRegion.tSize.iWidth - tClippdRegion.tSize.iWidth;
                tHeaderRegion.tLocation.iX += tClippdRegion.tSize.iWidth;

                if (tTargetRegion.tLocation.iY < 0)
                {
                    tHeaderRegion.tSize.iHeight =
                        tClippdRegion.tSize.iHeight - tTargetRegion.tLocation.iY;
                    tHeaderRegion.tLocation.iY = tTargetRegion.tLocation.iY;
                }

                tResult = __tile_clipped_pave(&this, ptTarget, &tHeaderRegion, NULL, this.wMode);
            ...
            */
            ...
            if (tClippdRegion.tSize.iHeight < tDrawRegion.tSize.iHeight)
            {
                ...
                tFirstColumnRegion.tSize.iHeight =
                    tDrawRegion.tSize.iHeight - tClippdRegion.tSize.iHeight;
                tFirstColumnRegion.tLocation.iY += tClippdRegion.tSize.iHeight;

                if (tTargetRegion.tLocation.iX < 0)
                {
                    tFirstColumnRegion.tSize.iWidth =
                        tClippdRegion.tSize.iWidth - tTargetRegion.tLocation.iX;
                    tFirstColumnRegion.tLocation.iX = tTargetRegion.tLocation.iX;
                }

                tResult =
                    __tile_clipped_pave(&this, ptTarget, &tFirstColumnRegion, NULL, this.wMode);
            ...
            */
                ...
                (tClippdRegion.tSize.iHeight < tDrawRegion.tSize.iHeight))
            {
                ...
                tNonNegRegion.tSize.iHeight =
                    tDrawRegion.tSize.iHeight - tClippdRegion.tSize.iHeight;
                tNonNegRegion.tLocation.iX += tClippdRegion.tSize.iWidth;
                tNonNegRegion.tLocation.iY += tClippdRegion.tSize.iHeight;

                tResult = __tile_non_negtive_location_pave(
                    &this, this.Source.ptTile,

                    //! [Modify][Target.ptTile]
                    // this.Target.ptTile,
                    // this.use_as__arm_2d_op_core_t.Runtime.ptTargetTile,
                    ptTarget, &tNonNegRegion, this.wMode);
                if (tResult < 0)
                {
                    return tResult;
                }
    ...
    {
        tResult =
            __tile_non_negtive_location_pave(&this, this.Source.ptTile,

                                             //! [Modify][Target.ptTile]
                                             // this.Target.ptTile,
                                             // this.use_as__arm_2d_op_core_t.Runtime.ptTargetTile,
                                             ptTarget, &tTargetRegion, this.wMode);
    }
...
arm_fsm_rt_t __arm_2d_op_depose(arm_2d_op_core_t *ptThis, arm_fsm_rt_t tResult)
{
    // arm_irq_safe
    {
        this.tResult = tResult;
        this.Status.tValue =
            ((tResult < 0) ? __ARM_2D_OP_STATUS_IO_ERROR_msk : 0) | __ARM_2D_OP_STATUS_CPL_msk;
    }
    return tResult;
}

__WEAK
arm_fsm_rt_t __arm_2d_op_frontend_on_leave(arm_2d_op_core_t *ptThis, arm_fsm_rt_t tResult)
{
...
arm_fsm_rt_t __arm_2d_op_frontend_op_decoder(arm_2d_op_core_t *ptThis)
{
    ...
    //! decode operation
    switch (this.ptOp->Info.Param.chValue & (ARM_2D_OP_INFO_PARAM_HAS_SOURCE
                                             //|   ARM_2D_OP_INFO_PARAM_HAS_ORIGIN
                                             ...
                                             ))
    {
        ...
        case (ARM_2D_OP_INFO_PARAM_HAS_SOURCE | ARM_2D_OP_INFO_PARAM_HAS_TARGET):
...
arm_2d_op_status_t arm_2d_get_op_status(arm_2d_op_core_t *ptOP)
{
    ...
    volatile arm_2d_op_status_t *ptStatus = (volatile arm_2d_op_status_t *)&(this.Status);
...
bool __arm_2d_valid_mask(const arm_2d_tile_t *ptAlpha, uint_fast8_t chAllowMask)
{
    do
    {
        if (NULL == ptAlpha)
...
arm_2d_err_t __arm_mask_validate(const arm_2d_tile_t *ptSource, const arm_2d_tile_t *ptSrcMask,
                                 const arm_2d_tile_t *ptTarget, const arm_2d_tile_t *ptDesMask,
                                 uint32_t wMode)
{
    ARM_2D_UNUSED(wMode);
    ...
    if (NULL != ptSrcMask)
    {
        ...
        if (!__arm_2d_valid_mask(ptSrcMask, __ARM_2D_MASK_ALLOW_A8
    ...
    if (NULL != ptDesMask)
    {
        ...
        if (!__arm_2d_valid_mask(ptDesMask, __ARM_2D_MASK_ALLOW_A8
#if __ARM_2D_CFG_SUPPORT_COLOUR_CHANNEL_ACCESS__
                                                | __ARM_2D_MASK_ALLOW_8in32
#endif
                                 ))
