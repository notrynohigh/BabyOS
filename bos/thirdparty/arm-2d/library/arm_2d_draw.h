...
#define arm_2d_c8bit_draw_point(__TARGET_ADDR, /* target tile address */ \
    ...
    arm_2dp_gray8_draw_point(NULL, (__TARGET_ADDR), (__LOCATION), (__COLOUR), (255))

#define arm_2d_rgb16_draw_point(__TARGET_ADDR, /* target tile address */ \
                                __LOCATION,    /* point coordinate */    \
                                __COLOUR)      /* target colour */       \
    arm_2dp_rgb565_draw_point(NULL, (__TARGET_ADDR), (__LOCATION), (__COLOUR), (255))

#define arm_2d_rgb32_draw_point(__TARGET_ADDR, /* target tile address */ \
                                __LOCATION,    /* point coordinate */    \
                                __COLOUR)      /* target colour */       \
    arm_2dp_cccn888_draw_point(NULL, (__TARGET_ADDR), (__LOCATION), (__COLOUR), (255))

#define arm_2d_gray8_draw_point(__TARGET_ADDR, /* target tile address */ \
                                __LOCATION,    /* point coordinate */    \
                                __COLOUR,      /* target colour */       \
                                ...)                                     \
    arm_2dp_gray8_draw_point(NULL, (__TARGET_ADDR), (__LOCATION), (__COLOUR), (255, ##__VA_ARGS__))

#define arm_2d_rgb565_draw_point(__TARGET_ADDR, /* target tile address */ \
                                 __LOCATION,    /* point coordinate */    \
                                 __COLOUR,      /* target colour */       \
                                 ...)                                     \
    arm_2dp_rgb565_draw_point(NULL, (__TARGET_ADDR), (__LOCATION), (__COLOUR), (255, ##__VA_ARGS__))

#define arm_2d_cccn888_draw_point(__TARGET_ADDR, /* target tile address */      \
                                  __LOCATION,    /* point coordinate */         \
                                  __COLOUR,      /* target colour */            \
                                  ...)                                          \
    arm_2dp_cccn888_draw_point(NULL, (__TARGET_ADDR), (__LOCATION), (__COLOUR), \
                               (255, ##__VA_ARGS__))
...
#define arm_2d_c8bit_draw_pattern(__PATTERN_ADDR, /* pattern tile address */                       \
    ...
    arm_2dp_c8bit_draw_pattern(NULL, (__PATTERN_ADDR), (__TARGET_ADDR), (__REGION_ADDR), (__MODE), \
                               (__FG_COLOUR), (__BG_COLOUR))
...
#define arm_2d_rgb16_draw_pattern(__PATTERN_ADDR, /* pattern tile address */                       \
                                  ...
                                  __FG_COLOUR,    /* foreground colour */                          \
                                  __BG_COLOUR)    /* background colour */                          \
    arm_2dp_rgb16_draw_pattern(NULL, (__PATTERN_ADDR), (__TARGET_ADDR), (__REGION_ADDR), (__MODE), \
                               (__FG_COLOUR), (__BG_COLOUR))
...
#define arm_2d_rgb32_draw_pattern(__PATTERN_ADDR, /* pattern tile address */                       \
                                  ...
                                  __FG_COLOUR,    /* foreground colour */                          \
                                  __BG_COLOUR)    /* background colour */                          \
    arm_2dp_rgb32_draw_pattern(NULL, (__PATTERN_ADDR), (__TARGET_ADDR), (__REGION_ADDR), (__MODE), \
                               (__FG_COLOUR), (__BG_COLOUR))

#define arm_2d_c8bit_fill_colour(__TARGET_ADDR, /* target tile address*/   \
                                 __REGION_ADDR, /* target region address*/ \
                                 __COLOUR)      /* colour */               \
    arm_2dp_c8bit_fill_colour(NULL, (__TARGET_ADDR), (__REGION_ADDR), (__COLOUR))

#define arm_2d_rgb16_fill_colour(__TARGET_ADDR, /* target tile address*/   \
                                 __REGION_ADDR, /* target region address*/ \
                                 __COLOUR)      /* colour */               \
    arm_2dp_rgb16_fill_colour(NULL, (__TARGET_ADDR), (__REGION_ADDR), (__COLOUR))

#define arm_2d_rgb32_fill_colour(__TARGET_ADDR, /* target tile address*/   \
                                 __REGION_ADDR, /* target region address*/ \
                                 __COLOUR)      /* colour */               \
    arm_2dp_rgb32_fill_colour(NULL, (__TARGET_ADDR), (__REGION_ADDR), (__COLOUR))
...
enum
{
    ...
    // ARM_2D_DRW_PATN_MODE_FILL             =  _BV(0),                          //!< not support
    // yet ARM_2D_DRW_PATN_MODE_Y_MIRROR         =  _BV(2),                          //!< not
    // support yet ARM_2D_DRW_PATN_MODE_X_MIRROR         =  _BV(3),                          //!<
    // not support yet
                                                  ...
                                                  uint_fast8_t            chColour)
{
    ...
    B_ASSERT(ptTarget->bIsRoot);  // must be root tile
    B_ASSERT(tLocation.iX < ptTarget->tRegion.tSize.iWidth);
    B_ASSERT(tLocation.iY < ptTarget->tRegion.tSize.iHeight);

    uint8_t *pchPoint =
        ptTarget->pchBuffer + tLocation.iY * ptTarget->tRegion.tSize.iWidth + tLocation.iX;
                                                  ...
                                                  uint_fast16_t           hwColour)
{
    ...
    uint16_t *phwPoint =
        ptTarget->phwBuffer + tLocation.iY * ptTarget->tRegion.tSize.iWidth + tLocation.iX;
                                                  ...
                                                  uint32_t                wColour)
{
    ...
    uint32_t *pwPoint =
        ptTarget->pwBuffer + tLocation.iY * ptTarget->tRegion.tSize.iWidth + tLocation.iX;
    *pwPoint = wColour;
}
...
extern ARM_NONNULL(2) arm_fsm_rt_t
    arm_2dp_gray8_draw_point(arm_2d_op_drw_pt_t *ptOP, const arm_2d_tile_t *ptTarget,
                             const arm_2d_location_t tLocation, uint_fast8_t chColour,
                             uint8_t chOpacity);
 ...
 */
extern ARM_NONNULL(2) arm_fsm_rt_t
    arm_2dp_rgb565_draw_point(arm_2d_op_drw_pt_t *ptOP, const arm_2d_tile_t *ptTarget,
                              const arm_2d_location_t tLocation, uint_fast16_t hwColour,
                              uint8_t chOpacity);
 ...
 */
extern ARM_NONNULL(2) arm_fsm_rt_t
    arm_2dp_cccn888_draw_point(arm_2d_op_drw_pt_t *ptOP, const arm_2d_tile_t *ptTarget,
                               const arm_2d_location_t tLocation, uint32_t wColour,
                               uint8_t chOpacity);
...
extern ARM_NONNULL(2, 3) arm_fsm_rt_t
    arm_2dp_c8bit_draw_pattern(arm_2d_op_drw_patn_t *ptOP, const arm_2d_tile_t *ptPattern,
                               const arm_2d_tile_t *ptTarget, const arm_2d_region_t *ptRegion,
                               uint32_t wMode, uint8_t chForeColour, uint8_t chBackColour);
 ...
 */
extern ARM_NONNULL(2, 3) arm_fsm_rt_t
    arm_2dp_rgb16_draw_pattern(arm_2d_op_drw_patn_t *ptOP, const arm_2d_tile_t *ptPattern,
                               const arm_2d_tile_t *ptTarget, const arm_2d_region_t *ptRegion,
                               uint32_t wMode, uint16_t hwForeColour, uint16_t hwBackColour);
 ...
 */
extern ARM_NONNULL(2, 3) arm_fsm_rt_t
    arm_2dp_rgb32_draw_pattern(arm_2d_op_drw_patn_t *ptOP, const arm_2d_tile_t *ptPattern,
                               const arm_2d_tile_t *ptTarget, const arm_2d_region_t *ptRegion,
                               uint32_t wMode, uint32_t wForeColour, uint32_t wBackColour);
 ...
 */
extern ARM_NONNULL(2) arm_fsm_rt_t
    arm_2dp_c8bit_fill_colour(arm_2d_op_fill_cl_t *ptOP, const arm_2d_tile_t *ptTarget,
                              const arm_2d_region_t *ptRegion, uint_fast8_t chColour);
 ...
 */
extern ARM_NONNULL(2) arm_fsm_rt_t
    arm_2dp_rgb16_fill_colour(arm_2d_op_fill_cl_t *ptOP, const arm_2d_tile_t *ptTarget,
                              const arm_2d_region_t *ptRegion, uint_fast16_t hwColour);
 ...
 */
extern ARM_NONNULL(2) arm_fsm_rt_t
    arm_2dp_rgb32_fill_colour(arm_2d_op_fill_cl_t *ptOP, const arm_2d_tile_t *ptTarget,
                              const arm_2d_region_t *ptRegion, uint32_t wColour);
