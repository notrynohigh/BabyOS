...
#define arm_2d_convert_colour_to_rgb888(__SRC_ADDR, /* source tile address */ \
    ...
    arm_2dp_convert_colour_to_rgb888(NULL, (__SRC_ADDR), (__DES_ADDR))

#define arm_2d_convert_colour_to_rgb565(__SRC_ADDR, /* source tile address */ \
                                        __DES_ADDR /* target tile address */) \
    arm_2dp_convert_colour_to_rgb565(NULL, (__SRC_ADDR), (__DES_ADDR))
 ...
 */
ARM_NONNULL(2)
__STATIC_INLINE void __arm_2d_brga8888_unpack(uint32_t wColor, __arm_2d_color_fast_rgb_t *ptRGB)
{
    B_ASSERT(NULL != ptRGB);
...
__STATIC_INLINE uint8_t __arm_2d_gray8_pack(__arm_2d_color_fast_rgb_t *ptRGB)
{
    ...
    return (uint8_t)((tGrayScale <= 255) * tGrayScale + (tGrayScale > 255) * 255);
}
...
extern ARM_NONNULL(2, 3) arm_fsm_rt_t
    arm_2dp_convert_colour_to_gray8(arm_2d_op_cl_convt_t *ptOP, const arm_2d_tile_t *ptSource,
 ...
 */
extern ARM_NONNULL(2, 3) arm_fsm_rt_t
    arm_2dp_convert_colour_to_rgb888(arm_2d_op_cl_convt_t *ptOP, const arm_2d_tile_t *ptSource,
                                     const arm_2d_tile_t *ptTarget);
/*!
 ...
 */
extern ARM_NONNULL(2, 3) arm_fsm_rt_t
    arm_2dp_convert_colour_to_rgb565(arm_2d_op_cl_convt_t *ptOP, const arm_2d_tile_t *ptSource,
                                     const arm_2d_tile_t *ptTarget);
