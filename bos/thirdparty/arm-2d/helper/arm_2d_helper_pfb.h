    ...
    ({                                                                                         \
        ...
        {                                                                                      \
            ...
            __PIXEL_TYPE tBuffer[(__PFB_WIDTH) * (__PFB_HEIGHT)];                              \
                                                                                               ...
                                                                                               \
        arm_2d_helper_pfb_cfg_t tCFG = {.tDisplayArea.tSize =                                  \
                                            {                                                  \
 ...
 */
#define ARM_2D_HELPER_PFB_UPDATE_ON_DRAW_HANDLER(__CB_ADDR, /* PFB Helper object address */   \
                                                 __HANDLER, /* new on-draw-handler function*/ \
                                                 ...)       /* An optional target address */  \
    arm_2d_helper_pfb_update_dependency((__CB_ADDR), ARM_2D_PFB_DEPEND_ON_DRAWING,            \
...
#define __ADD_REGION_TO_LIST(__NAME, ...)                                                 \
    {                                                                                     \
        .ptNext  = (arm_2d_region_list_item_t *)&(__NAME[__COUNTER__ - __NAME##_offset]), \
        .tRegion = {__VA_ARGS__},                                                         \
    }
...
#define __ADD_LAST_REGION_TO_LIST(__NAME, ...)    \
    {                                             \
        .ptNext = NULL, .tRegion = {__VA_ARGS__}, \
    }
 ...
 *
 */
#define init_arm_2d_helper_pfb(__CB_ADDR, __SCREEN_WIDTH, __SCREEN_HEIGHT, __PIXEL_TYPE, __WIDTH, \
                               __HEIGHT, __PFB_NUM, ...)                                          \
    ARM_2D_HELPER_PFB_INIT(__CB_ADDR, __SCREEN_WIDTH, __SCREEN_HEIGHT, __PIXEL_TYPE, __WIDTH,     \
                           __HEIGHT, __PFB_NUM, ##__VA_ARGS__)
 ...
 * \return arm_2d_err_t the process result
 */
#define update_arm_2d_helper_pfb_on_draw_handler(__CB_ADDR, /* PFB Helper object address */   \
                                                 __HANDLER, /* new on-draw-handler function*/ \
                                                 ...)       /* An optional target address */  \
    ARM_2D_HELPER_PFB_UPDATE_ON_DRAW_HANDLER((__CB_ADDR), (__HANDLER), ##__VA_ARGRS__)
...
#define arm_2d_helper_pfb_report_rendering_complete(__PFB_HELPER_PTR, ...) \
    __arm_2d_helper_pfb_report_rendering_complete((__PFB_HELPER_PTR), (NULL, ##__VA_ARGS__))
 ...
 */
typedef void arm_2d_helper_render_handler_t(void *pTarget, const arm_2d_pfb_t *ptPFB,
                                            bool bIsNewFrame);
...
typedef struct arm_2d_helper_pfb_cfg_t
{
    ...
    struct
    {
        ...
        uint16_t      bDoNOTUpdateDefaultFrameBuffer : 1;  //!< A flag to disable automatically
                                                           //!< default-framebuffer-registration
        uint16_t bDisableDynamicFPBSize : 1;  //!< A flag to disable resize of the PFB block
        uint16_t
            bSwapRGB16 : 1;  //!< A flag to enable swapping high and low bytes of an RGB16 pixel
...
struct arm_2d_helper_pfb_t
{
    ...
    ARM_PRIVATE(arm_2d_helper_pfb_cfg_t tCFG;  //!< user configuration
...
typedef struct
{
    ...
    ARM_PRIVATE(
        arm_2d_region_list_item_t tDirtyRegions[2]; arm_2d_op_t * ptTransformOP;
 ...
 * \return arm_2d_err_t the process result
 */
extern ARM_NONNULL(1, 2) arm_2d_err_t
    arm_2d_helper_pfb_init(arm_2d_helper_pfb_t *ptThis, arm_2d_helper_pfb_cfg_t *ptCFG);
 ...
 */
extern ARM_NONNULL(1) arm_2d_region_t
    arm_2d_helper_pfb_get_display_area(arm_2d_helper_pfb_t *ptThis);
 ...
 */
extern ARM_NONNULL(1) arm_2d_size_t arm_2d_helper_pfb_get_pfb_size(arm_2d_helper_pfb_t *ptThis);
 ...
 */
extern ARM_NONNULL(1) arm_fsm_rt_t
    arm_2d_helper_pfb_task(arm_2d_helper_pfb_t *ptThis, arm_2d_region_list_item_t *ptDirtyRegions);
 ...
 * \param[in] ptThis an initialised PFB helper control block
 */
extern ARM_NONNULL(1) void arm_2d_helper_pfb_flush(arm_2d_helper_pfb_t *ptThis);

/*!
 * \brief hide the navigation layer
 * \param[in] ptThis an initialised PFB helper control block
 */
extern ARM_NONNULL(1) void arm_2d_helper_hide_navigation_layer(arm_2d_helper_pfb_t *ptThis);

/*!
 * \brief show the navigation layer if there is a valid one
 * \param[in] ptThis an initialised PFB helper control block
 */
extern ARM_NONNULL(1) void arm_2d_helper_show_navigation_layer(arm_2d_helper_pfb_t *ptThis);

/*!
 * \brief ignore the low level PFB flushing only
 * \param[in] ptThis an initialised PFB helper control block
 */
extern ARM_NONNULL(1) void arm_2d_helper_ignore_low_level_flush(arm_2d_helper_pfb_t *ptThis);

/*!
 * \brief resume the low level PFB flushing
 * \param[in] ptThis an initialised PFB helper control block
 */
extern ARM_NONNULL(1) void arm_2d_helper_resume_low_level_flush(arm_2d_helper_pfb_t *ptThis);
 ...
 * \return arm_2d_err_t the process result
 */
extern ARM_NONNULL(1, 3) arm_2d_err_t
    arm_2d_helper_pfb_update_dependency(arm_2d_helper_pfb_t *ptThis, uint_fast8_t chMask,
 ...
 */
extern ARM_NONNULL(1) void __arm_2d_helper_pfb_report_rendering_complete(
    arm_2d_helper_pfb_t *ptThis, arm_2d_pfb_t *ptPFB);
 ...
 */
extern ARM_NONNULL(1) arm_2d_pfb_t *__arm_2d_helper_pfb_new(arm_2d_helper_pfb_t *ptThis);
 ...
 */
extern ARM_NONNULL(1) void __arm_2d_helper_pfb_free(arm_2d_helper_pfb_t *ptThis,
                                                    arm_2d_pfb_t        *ptPFB);
 ...
 */
extern ARM_NONNULL(1, 2, 5) void arm_2d_helper_transform_init(
    arm_2d_helper_transform_t *ptThis, arm_2d_op_t *ptTransformOP, float fAngleStep,
    float fScaleStep, arm_2d_region_list_item_t **ppDirtyRegionList);
 ...
 */
extern ARM_NONNULL(1) void arm_2d_helper_transform_on_frame_begin(
 ...
 */
extern ARM_NONNULL(1) void arm_2d_helper_transform_update_value(arm_2d_helper_transform_t *ptThis,
 ...
 */
extern ARM_NONNULL(1, 2) void arm_2d_helper_transform_update_dirty_regions(
    arm_2d_helper_transform_t *ptThis, const arm_2d_region_t *ptCanvas, bool bIsNewFrame);
