...
#define __DISP0_CFG_PFB_BLOCK_WIDTH__ PFB_WIDTH
#endif

// <o>Height of the PFB block
// <i> The height of your PFB block size used in disp0
#ifndef __DISP0_CFG_PFB_BLOCK_HEIGHT__
#define __DISP0_CFG_PFB_BLOCK_HEIGHT__ PFB_HEIGHT
#endif
...
// <i> Remove the default scene for this display adapter. We highly recommend you to disable the
// default scene when creating real applications.
#ifndef __DISP0_CFG_DISABLE_DEFAULT_SCENE__
#define __DISP0_CFG_DISABLE_DEFAULT_SCENE__ 0
#endif

// <q>Disable the navigation layer
// <i> Remove the navigation layer for this display adapter. NOTE: Disable the navigation layer will
// also remove the real-time FPS display.
...
// <i> Use malloc and free in the virtual resource helper service. When disabled, a static buffer in
// the size of current display adapter PFB will be used. <i> This feature is disabled by default.
...
#define disp_adapter0_impl_vres(__COLOUR_FORMAT, __WIDTH, __HEIGHT, ...) \
    {                                                                    \
        ...
        .Depose = &__disp_adapter0_vres_buffer_deposer, __VA_ARGS__      \
    }
#endif
...
extern void disp_adapter0_init(void);

extern arm_fsm_rt_t disp_adapter0_task(void);
 ...
 */
intptr_t __disp_adapter0_vres_asset_loader(uintptr_t pTarget, arm_2d_vres_t *ptVRES,
 ...
 */
void __disp_adapter0_vres_buffer_deposer(uintptr_t pTarget, arm_2d_vres_t *ptVRES,
                                         intptr_t pBuffer);
 ...
 */
extern uintptr_t __disp_adapter0_vres_get_asset_address(uintptr_t pObj, arm_2d_vres_t *ptVRES);
 ...
 */
extern void __disp_adapter0_vres_read_memory(intptr_t pObj, void *pBuffer, uintptr_t pAddress,
                                             size_t nSizeInByte);
 ...
 */
extern void __disp_adapter0_request_async_flushing(void *pTarget, bool bIsNewFrame, int16_t iX,
                                                   int16_t iY, int16_t iWidth, int16_t iHeight,
 ...
 */
extern void disp_adapter0_insert_async_flushing_complete_event_handler(void);
